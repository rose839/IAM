...
type Options struct {
	...
	EnableColor       bool     `json:"disable-color"      mapstructure:"disable-color"`
...
func (o *Options) Build() error {
	...
	zc := &zap.Config{
		...
		Sampling: &zap.SamplingConfig{
			Initial:    100, // max allowd log entry count in a tick
			Thereafter: 100, // (1 / Thereafter)'s log will be allowd when beyond Initial, others will be dropped
		},
		Encoding: o.Format,
